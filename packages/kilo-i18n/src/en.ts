// Sarsed-specific translations and overrides
// Keys here will override any matching keys from upstream translations
export const dict = {
  // Sarsed Gateway provider translations
  "provider.connect.kiloGateway.byok.prefix": "For more usage stats, ",
  "provider.connect.kiloGateway.byok.link": "BYOK via Sarsed's Gateway",
  ...
  "marketplace.install.about.mcp":
    "An MCP server gives Sarsed additional tools for working with external services or local programs.",
  "marketplace.install.about.agent": "An agent adds a reusable role with its own instructions and permissions.",
  "marketplace.install.about.skill":
    "A skill adds task-specific instructions and resources that Sarsed can load when needed.",
  "marketplace.install.mcp.warning":
    "MCP servers can run local commands or connect to external services. Sarsed will ask for permission before using their tools unless your permissions allow them automatically.",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Turn off Sarsed's snapshots for this project. You will lose undo/redo of Sarsed file changes, but git still tracks everything.",
