...
export type MemoryZeroStatusData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  ...
  url: "/memory/zero/status"
}

export type MemoryZeroStatusErrors = {
  /**
   * MemoryApiClientError | InvalidRequestError
   */
  400: MemoryApiClientError | InvalidRequestError
...
export type MemoryZeroStatusError = MemoryZeroStatusErrors[keyof MemoryZeroStatusErrors]

export type MemoryZeroStatusResponses = {
  /**
   * Zero-Mem status
   */
  200: {
...
export type MemoryZeroStatusResponse = MemoryZeroStatusResponses[keyof MemoryZeroStatusResponses]

export type MemoryZeroRecallData = {
  body?: {
    query: string
    topK?: number
    sessionID?: string
  ...
  url: "/memory/zero/recall"
}

export type MemoryZeroRecallErrors = {
  /**
   * MemoryApiClientError | InvalidRequestError
   */
  400: MemoryApiClientError | InvalidRequestError
...
export type MemoryZeroRecallError = MemoryZeroRecallErrors[keyof MemoryZeroRecallErrors]

export type MemoryZeroRecallResponses = {
  /**
   * Zero-Mem recall
   */
  200: {
...
export type MemoryZeroRecallResponse = MemoryZeroRecallResponses[keyof MemoryZeroRecallResponses]
