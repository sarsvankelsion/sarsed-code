...
import type {
  ...
  MemoryZeroRecallErrors,
  MemoryZeroRecallResponses,
  MemoryZeroStatusErrors,
...
export class Memory extends HeyApiClient {
   ...
   */
  public zeroStatus<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
    },
    ...
    return (options?.client ?? this.client).get<MemoryZeroStatusResponses, MemoryZeroStatusErrors, ThrowOnError>({
   ...
   */
  public zeroRecall<ThrowOnError extends boolean = false>(
    parameters: {
      directory?: string
      workspace?: string
      query: string
    ...
    return (options?.client ?? this.client).post<MemoryZeroRecallResponses, MemoryZeroRecallErrors, ThrowOnError>({
