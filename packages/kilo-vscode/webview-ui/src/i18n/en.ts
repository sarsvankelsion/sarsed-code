...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Install Anaconda Desktop on this machine, then return here. Sarsed does not run the installer for you.",
  ...
  "provider.anaconda.state.signedOut": "Open Anaconda Desktop and sign in before connecting Sarsed.",
  "provider.anaconda.state.unauthorized":
    "Sarsed could not access Anaconda Desktop. Open Desktop, sign in again, and restart it if needed.",
  ...
  "provider.anaconda.state.ready":
    "Sarsed found a healthy local text-generation server and can import its current connection settings.",
  ...
  "provider.anaconda.toast.refreshed.description": "The active local server and models are up to date in Sarsed.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Sarsed.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Sarsed.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Sarsed.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox is enabled. Agent shell commands are confined to the project and Sarsed directories.",
  "prompt.action.sandbox.disabled":
    "Sandbox is disabled. Click to confine agent shell command writes to the project and Sarsed directories.",
  ...
  "prompt.action.sandbox.description.enabled": "Writes are limited to the project and Sarsed directories.",
  ...
  "speechToText.tooltip.start": "Start voice input with Sarsed Gateway",
  ...
  "speechToText.error.loginRequired": "Sign in to Sarsed to use speech input.",
  ...
  "settings.config.title": "Open {{scope}} Sarsed config file",
  "settings.config.placeholder": "Config files are merged in order; files marked loaded currently affect settings.",
  "settings.config.noWorkspace": "Open a workspace folder to edit the local Sarsed config file.",
  "settings.config.openFailed": "Failed to open {{scope}} Sarsed config file: {{message}}",
  ...
  "workStyle.onboarding.welcome": "Welcome to Sarsed Code",
  ...
  "workStyle.choice.human-in-the-loop.description": "Sarsed pauses and shows you its plan as it works.",
  ...
  "session.cloud.import.placeholder": "Session ID, URL, or sarsed import command",
  ...
  "deviceAuth.title": "Sign in to Sarsed Code",
  ...
  "profile.action.login": "Login with Sarsed Code",
  ...
  "profile.usage.routing": "Plan billing is active. Sarsed Gateway routing is {{state}}.",
  ...
  "profile.pass.subscribe": "Get Sarsed Pass to add credits and earn bonuses",
  "profile.pass.bonus": "Bonus",
  "profile.pass.usage": "This month's usage",
  "profile.pass.paid": "Paid",
  "profile.pass.meter": "Sarsed Pass monthly usage",
  ...
  "settings.indexing.kiloModel.title": "Sarsed model preset",
  "settings.indexing.kiloModel.description": "Choose a supported Sarsed-hosted embedding model.",
  "settings.indexing.kiloSignIn.title": "Sarsed sign-in required",
  "settings.indexing.kiloSignIn.description": "Sign in to Sarsed to use hosted embeddings.",
  ...
  "settings.aboutKiloCode.title": "About Sarsed Code",

  "session.messages.welcome":
    "Sarsed Code is an AI coding agent & security auditor. Ask it to build features, validate security, or explain your codebase.",
  ...
  "sidebar.topBar.label": "Sarsed Code navigation",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "File does not contain valid Sarsed settings.",
  "settings.aboutKiloCode.importSettings.tooLarge": "File is too large. Settings files must be under 1 MB.",
  "settings.aboutKiloCode.importSettings.newerVersion":
    "This file was exported from a newer version of Sarsed. Some settings may be ignored.",
  ...
  "settings.notifications.workbench.description":
    "Show VS Code notifications when Sarsed completes a task or needs your input",
  "settings.notifications.os.title": "Enable OS Notifications",
  "settings.notifications.os.description":
    "Show native OS notification alerts when Sarsed completes a task or needs your input while VS Code is not active.",
  ...
  "settings.experimental.sharedAgentBoard.title": "Sarsed Swarm",
  ...
  "settings.models.speechToText.disabledDescription":
    "Enable and sign in to the Sarsed provider to use Speech to Text. Speech to Text is currently only supported through Sarsed Gateway.",
  "settings.models.speechToTextModel.title": "Speech to Text Model",
  "settings.models.speechToTextModel.description": "Choose the Sarsed Gateway transcription model for voice input.",
  ...
  "settings.sandboxing.enabled.description":
    "Run agent shell commands inside an OS-level sandbox that restricts writes to the project and Sarsed state directories",
  ...
  "settings.experimental.claudeMigration.description":
    "On the next backend start, import supported global CLAUDE.md instructions, simple skills, and disabled MCP definitions. This runs once with no automatic retry; global Claude instructions and skills are then handed off to Sarsed. Claude files stay unchanged; keep them if you still use Claude Code.",
  ...
  "settings.experimental.remote.description":
    "Enable remote control of sessions via Sarsed Cloud. This will also affect CLIs on this machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Load CLAUDE.md instructions and skills from your Claude Code configuration directory into sessions. Enable this if you want Sarsed to use your Claude Code instructions and skills. Requires restart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No MCP servers configured. Add MCP servers in sarsed.jsonc, or ask the agent to add them for you.",
  ...
  "prompt.memory.label": "Project memory",
  "prompt.memory.off": "Memory off",
  "prompt.memory.onTokens": "Memory · ~{{tokens}}",
  "prompt.memory.loading": "Loading memory…",
  "prompt.memory.offline": "Memory unavailable (offline)",
  "prompt.memory.offlineHint": "Not connected to the CLI backend. Check the connection and try again.",
  "prompt.memory.disabled": "Project memory is disabled.",
  "prompt.memory.enabledTokens": "Enabled · ~{{tokens}} stored tokens",
  "prompt.memory.enable": "Enable",
  "prompt.memory.disable": "Disable",
  "prompt.memory.autoOn": "Auto-save on",
  "prompt.memory.autoOff": "Auto-save off",
  "prompt.memory.remember": "Remember",
  "prompt.memory.correct": "Correct",
  "prompt.memory.forget": "Forget",
  "prompt.memory.rememberPlaceholder": "Save a project note, e.g. Test with bun from packages/opencode",
  "prompt.memory.correctPlaceholder": "Correct stored memory, e.g. Tests run from repo root, not packages",
  "prompt.memory.forgetPlaceholder": "Query to remove, e.g. old deploy command",
  "prompt.memory.save": "Save",
  "prompt.memory.status": "Status",
  "prompt.memory.rebuild": "Rebuild",
  "prompt.memory.inspect": "Inspect",
  "prompt.memory.purge": "Delete all…",
  "prompt.memory.purgeConfirm": "Delete ALL project memory? This cannot be undone.",
  "prompt.memory.purgeYes": "Yes, delete",
  "prompt.memory.purgeNo": "Cancel",
  "prompt.memory.zeroLine": "Zero-Mem · {{traces}} traces · {{episodes}} episodes · {{entities}} entities · 0 LLM tokens",
  "chat.memory.project.disabled": "Project memory disabled",
  "chat.memory.project.empty": "This project doesn't have any memory yet. It will start showing after you use Sarsed.",
  ...
  "settings.display.fontSize.description": "Adjust the Sarsed webview UI font size independently from VS Code.",
  ...
  "settings.models.hidePromptTraining.description":
    "Hide Sarsed Gateway models whose providers may use your prompts for training.",
  ...
  "diffViewer.source.session.tooltip":
    "Files changed by Sarsed during the current session, based on per-turn snapshots. Resets when you start a new session.",
